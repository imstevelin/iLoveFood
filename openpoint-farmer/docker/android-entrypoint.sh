...
capture_env FARMER_LOG_API_REQUESTS "${FARMER_LOG_API_REQUESTS:-}"
capture_env FARMER_HTTP_THREADS "${FARMER_HTTP_THREADS:-}"
capture_env FARMER_LOG_QUEUE_WARNINGS "${FARMER_LOG_QUEUE_WARNINGS:-}"
...
capture_env FARMER_ANDROID_BOOT_TIMEOUT_SECONDS "${FARMER_ANDROID_BOOT_TIMEOUT_SECONDS:-}"
